...
//for listing images
    ...
    public function save_metabox($post_id, $post) {
        ...
        /* update_post_meta($event_id, 'dwt_listing_listing_fb', $listing_fb);
          update_post_meta($event_id, 'dwt_listing_listing_tw', $listing_tw);
          update_post_meta($event_id, 'dwt_listing_listing_google', $listing_google);
          update_post_meta($event_id, 'dwt_listing_listing_in', $listing_in);
          update_post_meta($event_id, 'dwt_listing_youtube', $listing_youtube);
          update_post_meta($event_id, 'dwt_listing_insta', $listing_insta); */
    }
