        ...
        <?php
            ...
            if( count((array)  $media ) > 0 )
            {
				foreach( $media as $m )
				{
					...
					{
				?>
						<li data-thumb="<?php echo esc_url($thumb_imgs[0]); ?>"> <a href="<?php echo esc_url($full_img[0]); ?>" data-fancybox="group"> <img src="<?php echo esc_url( $img[0] ); ?>" alt="<?php echo esc_html__('image not found','dwt-listing'); ?>" /> </a> </li>
                <?php
					}
					else
					{
					?>
						<li data-thumb="<?php echo esc_url(dwt_listing_defualt_img_url()); ?>"> <a href="<?php echo esc_url(dwt_listing_defualt_img_url()); ?>" data-fancybox="group"> <img src="<?php echo esc_url( dwt_listing_defualt_img_url() ); ?>" alt="<?php echo esc_html__('image not found','dwt-listing'); ?>" /> </a> </li>
				<?php
					}
				}
            }
