      ...
      <div class="col-lg-12 col-xs-12 col-md-12 col-sm-12">
        <div class="row">
          <div class="listing-page-slider owl-carousel owl-theme">
			...
			?>
            <div class="item">
              <div class="carosual-content"> <a href="<?php echo esc_url($full_img[0]); ?>" data-fancybox="group"> <img src="<?php echo esc_url( $img[0] ); ?>" class="img-responsive" alt="<?php echo esc_attr($title); ?> "/> </a>
              </div>
            </div>
            <?php
					}
					...
					?>
                    <div class="item">
              <div class="carosual-content"> <a href="<?php echo esc_url(dwt_listing_defualt_img_url()); ?>" data-fancybox="group"> <img src="<?php echo esc_url(dwt_listing_defualt_img_url()); ?>" class="img-responsive" alt="<?php echo esc_attr($title); ?> "/> </a>
              </div>
            </div>
                    <?php
					}
