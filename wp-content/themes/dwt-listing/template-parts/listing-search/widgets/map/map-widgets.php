            ...
            <div class="col-md-12 col-xs-12 col-sm-12">
                <div class="row">
                                        ...
                                        <div class="typeahead__container">
                                            <div class="typeahead__field">
                                                <div class="typeahead__query">
                                                    <input name="by_title" value="<?php echo esc_attr($by_title); ?>" autocomplete="off" type="search" class="for_search_pages form-control specific_search" placeholder="<?php echo esc_html__('What Are You Looking For?', 'dwt-listing'); ?>">
                                                </div>
                                ...
                                <div class="col-md-6 col-xs-12 col-sm-4">
                                    <div class="search-widget">
                                        <div class="form-group specific-search">
                                            <input class="form-control" id="address_location" name="street_address" placeholder="<?php echo esc_html__('Address or city', 'dwt-listing'); ?>"  value="<?php echo esc_attr($street_address); ?>" type="text">
                                            <?php if (dwt_listing_text('dwt_listing_enable_geo') == '1') { ?>
                                                ...
                                                <?php if (dwt_listing_text('dwt_map_selection') == 'open_street') { ?>
                                                    <input name="latitude" type="hidden" id="search_lat" value="<?php echo esc_attr($lat); ?>">
                                                    <input name="longitude" type="hidden" id="search_lon" value="<?php echo esc_attr($lon); ?>">
                                                <?php } ?>
                                            <?php } ?>
                            ...
                            <div class="main-filters">
                                            ...
                                            <ul>
                                                <li class="dropdown">
                                                    <a href="javascript:void(0)" class="dropdown btn" data-toggle="dropdown">
                                                        <span> <?php echo esc_html__('Cost Range', 'dwt-listing'); ?></span> <span class="caret"></span>
                                                    </a>
                                                        ...
                                                        foreach ($price_type as $type) {
                                                            ...
                                                            <div class="list-group price-range">
                                                                <div class="list-group-item">
                                                                    <div class="desc-text">
                                                                        <span><input  class="custom-checkbox cost_range" name="cost_range" <?php echo esc_attr($selective); ?>  value="<?php echo esc_attr($type->term_id); ?>" type="radio" ></span>
                                ...
                                <?php if (dwt_listing_text('donwtown_search_byopen') == '1') { ?>
                                    <div class="filter filter-timing">
                                        <label for="status_success" class="btn <?php echo esc_attr($class); ?>"><i class="ti-timer"></i><?php echo esc_html__('Open Now', 'dwt-listing'); ?> 
                                ...
                                <?php if (dwt_listing_text('donwtown_search_byrated') == '1') { ?>
                                    <div class="filter filter-rated">
                                        <label class="btn <?php echo esc_attr($class1); ?>"><i class="ti-stats-up"></i><?php echo esc_html__('Highly Rated', 'dwt-listing'); ?> <input type="checkbox" value="high_rated" name="l_rating" id="rated" class="badgebox h_rated"></label>
                                    </div>
                                <?php } ?>   
                            </div>
                                    ...
                                    if (count((array) $terms) > 0 && !is_wp_error($terms)) {
                                        ...
                                        <div class="panel-group" id="accordionz" role="tablist" aria-multiselectable="true">
                                            ...
                                            <div class="panel panel-default">
                                                ...
                                                <div id="featurez" class="panel-collapse collapse <?php echo esc_attr($active_class); ?>" role="tabpanel" aria-labelledby="feat_anam">
                                                        ...
                                                        <div id="show_on_request">
                                                            <ul class="list-inline" >
                                                                ...
                                                                foreach ($terms as $term) {
                                                                    ...
                                                                    ?>
                                                                    <li>
                                                                        <input type="checkbox" id="<?php echo esc_url($term->slug); ?>" name="amenties[]"  <?php echo esc_attr($selective); ?> value="<?php echo esc_attr($term->term_id); ?>" class="custom-checkbox">
                                                                        <label for="<?php echo esc_url($term->slug); ?>"><?php echo esc_attr($term->name); ?></label>
                                                                    </li>
                                                                    <?php
                                                                }
                                                                ?>
                                                                <input class="btn btn-theme" id="d_getfilters" type="button" value="<?php echo esc_html__('Filter', 'dwt-listing'); ?>" >
                    ...
                    <div class="result-area">
                        ...
                        ?>
                        <div class="col-md-12 col-xs-12 col-sm-12">
                            <h4 class="pull-left <?php echo esc_attr($flip); ?>"> <strong> <?php echo esc_attr($results->found_posts); ?> </strong> <?php echo esc_html__('Results found', 'dwt-listing'); ?><span id="result_reset">
                                    <?php
                                    if (!empty($_GET)) {
