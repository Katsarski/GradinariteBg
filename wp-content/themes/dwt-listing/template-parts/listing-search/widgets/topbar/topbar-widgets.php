                ...
                <div class="location-filters">
                    <div class="input-group">
                        <div class="form-group has-icon has-clear">
                            <input type="text" class="form-control" placeholder="<?php echo esc_html__('Address or city', 'dwt-listing'); ?>"  name="street_address" id="address_location" value="<?php echo esc_attr($street_address); ?>">
        ...
        if (!empty($term_ID)) {
            ...
            if (count((array) $terms) > 0 && !is_wp_error($terms)) {
                ...
                <div class="amenties" >
                    ...
                    <input id="d_getfilters" class="btn btn-theme btn-sm" type="button" value="<?php echo esc_html__('Search', 'dwt-listing'); ?>">
