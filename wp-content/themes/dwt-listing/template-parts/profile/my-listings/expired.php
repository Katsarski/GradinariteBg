                ...
                <div class="panel-heading">
                    <div class="row">
                        ...
                        <div class="col-md-4 col-lg-4 col-xs-4 col-sm-4">
                            ...
                            <button type="button" id="ren_exp_list" class="btn sonu-button ren-exp-btn pull-right" data-loading-text="<i class='fa fa-spinner fa-spin '></i> Processing..."><?php echo __('Renew Listing', 'dwt-listing'); ?></button>
                            <?php } ?>
                        </div>
                    </div>
                </div>
                                ...
                                <tbody>
                                    ...
                                    while ($my_listings->have_posts()) {
                                        ...
                                        <tr class="unique-key-<?php echo esc_attr($listing_id); ?>">
                                            ...
                                            <td><a href="<?php echo get_the_permalink($listing_id); ?>"><span class="admin-listing-title"><?php echo get_the_title($listing_id); ?></span><span class="admin-listing-date"><i class="lnr lnr-calendar-full"></i>  <?php echo get_the_date(get_option('date_format'), $listing_id); ?></span></a> 
                                                <?php
                                                //Business Hours
                                            ...
                                            <td>
                                                <span class="action-icons active">
                                                    ...
                                                    if (dwt_listing_text('dwt_listing_disable_edit') == '1' && !is_super_admin(get_current_user_id())) {
                                                        ...
                                                        ?>
                                                        <a class="tool-tip reactive-my-listings" title="<?php echo esc_attr__('Re Active', 'dwt-listing'); ?>" href="javascript:void(0)" data-listing-id="<?php echo esc_attr($listing_id); ?>"><i class="lnr lnr-sync text-warning"></i></a>
                                            ...
                                            <?php if ($dwt_listing_options['dwt_listing_bult_renew_date'] == true) { ?>
                                                <td><input value="<?php echo $listing_id; ?>" class="expir_chk custom-checkbox" type="checkbox"></td>
                                            <?php } ?>
                                        </tr>
                                        <?php
                                    }
