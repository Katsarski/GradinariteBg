                                ...
                                <tbody>
                                    ...
                                    while ($my_listings->have_posts()) {
                                        ...
                                        <tr class="unique-key-<?php echo esc_attr($listing_id); ?>">
                                            ...
                                            <td><a href="javascript:void(0);"><span class="admin-listing-title"><?php echo get_the_title($listing_id); ?><?php echo dwt_listing_is_listing_featured($listing_id); ?></span><span class="admin-listing-date"><i class="lnr lnr-calendar-full"></i>  <?php echo get_the_date(get_option('date_format'), $listing_id); ?></span></a> 
                                                <?php
                                                //Business Hours
